<template>
  <!--Main Navigation-->  
      <!-- Navbar -->
    <app id="inspire"> 
    <v-app-bar app color="indigo darken-4" dark src="../../public/img/sample.jpg">
    
      <v-app-bar-nav-icon @click="drawer_toggle"></v-app-bar-nav-icon>
     ...
     <v-list-item nav>            
      ...
      <v-list-group v-for="item in items"
        ...
        <template v-slot:activator>
          <v-list-item-content>
            <v-list-item-title class="px-3" v-text="item.title"></v-list-item-title>
          </v-list-item-content>
        </template>
    ...
    footer: {
     ...
     items: [
          ...
          },
          {
            ...
            title: '작업현황 관리',          
            items: [
              { title: '기간별 금형 일정' , grant: 'manager' , to: {path: '/'}, action: 'mdi-chart-line-stacked'},
              { title: '부품별 공정 현황' , grant: 'manager' , to: {path: '/'}, action: 'mdi-chart-bar-stacked'},
          ...
          },
          {
            ...
            title: '매출 관리',
            items: [
              { title: '매출 관리' , grant: 'manager' , to: {path: '/sales'}, action: 'mdi-coin'},
            ],
          },
          {
